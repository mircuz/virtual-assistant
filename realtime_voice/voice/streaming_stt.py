...
class StreamingTranscriber:
    ...
    def detect_voice_activity(self, audio_chunk: np.ndarray, sample_rate: int = 16000) -> VADResult:
        """
        ...
        try:
            ...
            if is_speech:
                ...
                if self._speech_state == SpeechState.SPEAKING:
                    ...
                    elif current_time - self._silence_start_time > self.silence_duration_threshold:
            ...
            print(f"VAD error: {e}")
            return VADResult(is_speech=False, confidence=0.0, state=self._speech_state)
    ...
    def process_chunk(
        ...
        if vad_result.state == SpeechState.SPEECH_END and self._audio_buffer:
            # Concatenate buffered audio and transcribe
